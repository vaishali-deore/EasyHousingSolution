...
//   styleUrl: './view-property-owner.component.css'
// })
// export class ViewPropertyOwnerComponent {
...
export class ViewPropertyOwnerComponent {
  searchParams = { propertyName: '', ownerName: '' };
  properties = [
  ...
  searchProperties() {
    this.filteredProperties = this.properties.filter(p =>
      ...
      p.owner.toLowerCase().includes(this.searchParams.ownerName.toLowerCase())
    );
  }
